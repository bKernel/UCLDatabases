...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <br>
            <div class="col-xs-12">
                <h3 style="float: left">Manage Admins</h3>

                <a href="addNewAdmin.php">
                    <button class="btn" id="addNewAdmin" style="float: right">Add new Admin</button>
                </a>
            </div>
                                ...
                                <div class='col-md-12'>
                                    <div class=\"card-body\">
                                        ...
                                        <form action='../handlers/deleteUser.php' method='post'>
                                            ...
                                            <input id='submit' type='submit' value='Delete Admin'>                                      
                                        </form>
